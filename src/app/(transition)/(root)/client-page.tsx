...
import { Instagram, Linkedin, Moon, Sun, Twitter } from "react-feather";
  ...
  return (
    <div className={theme}>
      <div className="-z-10">
        ...
        <div
          className="absolute h-[calc(100vh-10vh)] w-full"
          style={{ top: "10vh" }}
        >
          <Map color={theme === "light" ? jsclBlack : jsclYellow} />
        </div>
      ...
      <header className="container relative z-10 mx-auto flex w-full justify-between p-4  text-black  dark:text-jscl-yellow">
        <div className="font-noto">
          JavaScript<span className="font-thin">Chile</span>
        </div>
        <div className="font-noto">
          <button
            onClick={() => {
      ...
      <main>
        ...
        <div className="w-full bg-jscl-yellow dark:bg-jscl-black">
          <div className="container mx-auto px-4 pb-8 pt-6">
            <h2 className="m-0 mb-4  font-noto text-4xl font-medium tracking-tight text-slate-900 dark:text-jscl-yellow">
              Eventos
            </h2>

            <h3 className="my-3 font-noto  text-2xl font-medium tracking-tight text-slate-900 dark:text-jscl-yellow">
              Esta semana
            </h3>
            <div className="grid grid-cols-1 gap-4">
              {!thisWeekEvents.length ? (
                <p className="text-slate-900 dark:text-jscl-yellow">
